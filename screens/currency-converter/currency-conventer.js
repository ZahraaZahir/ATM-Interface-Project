...
for (let i = 0; i < dropList.length; i++) {
    for (let currency_code in country_list) {
        ...
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "IQD" ? "selected" : "";
...
function getExchangeRate() {
    ...
    let url = `https://v6.exchangerate-api.com/v6/4a4c9d0b89759bb6f965f8c4/latest/${fromCurrency.value}`;
